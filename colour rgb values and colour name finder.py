...
# Example usage
name = input("Enter a color name: ")
rgb = get_color_from_name(name)
if rgb:
    print(f"The RGB values for {name} are {rgb}")
else:
    print(f"Unknown color name: {name}")

r, g, b = input("Enter RGB values (comma-separated): ").split(",")
rgb = (int(r.strip()), int(g.strip()), int(b.strip()))
name = get_name_from_color(rgb)
if name:
    print(f"The name of the color with RGB values {rgb} is {name}")
else:
    print(f"Unknown color with RGB values: {rgb}")
